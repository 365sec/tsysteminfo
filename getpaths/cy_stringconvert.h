	...
	namespace convert
	{
                ...
                */
                ...
                public:
					...
					static string IntToAnsi(int value);
					static wstring IntToWide(int value);
					static string  DoubleToAnsi(double value);
					static wstring  DoubleToWide(double value);
					...
					*/
					 ...
					 * @param const wstring & str, const wchar_t& ch
					 * @return int
					 * @note 
					 */
					static int CountChar(wstring& str, const wchar_t& ch);

					static bool isNum(string s);

					//实现将剪切板的内容改为指定的字符串
					static BOOL StringToClipBoard(const char* srcString);
                };
            }
}
